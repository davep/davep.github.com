---
title: Be the Keymaster!
category: Coding
tags: PISpy, PyPI, Python, Textual, Work
date: 2022-12-08 13:14 +0000
modified: 2026-04-28 10:21:31+0100
cover: /attachments/2022/12/08/textual-qrcode.webp
---

## That didn't go to plan

So... yeah... the dogfooding... When I wrote [my previous
post](/2022/11/26/on-dog-food.html) I had wanted to try and do a post
towards the end of each week, highlighting what I'd done on the "dogfooding"
front. Life kinda had other plans. Not in a terrible way, but it turns out
that getting both flu and Covid jabs (AKA "jags" as they tend to say in my
adopted home) on the same day doesn't really agree with me too well.
...
<div style="text-align: center;">
    <iframe
        ...
        title="FivePyFive" frameborder="0"
...
![A Textual QR Code](/attachments/2022/12/08/textual-qrcode.webp#centre)
...
just recording, streak app for the Terminal.
...
"just so"? If so, do let folk know, and come yell about it on the
[`#show-and-tell`
channel](https://discord.com/channels/1026214085173461072/1033752599112994867)
in [the Discord server](https://discord.gg/Enf6Z3qhVr).

> [!note]
>
> This personal development blog post was [first hosted on the Textual
> devlog](https://textual.textualize.io/blog/2022/12/08/be-the-keymaster/).

[//]: # (2022-12-08-be-the-keymaster.md ends here)
