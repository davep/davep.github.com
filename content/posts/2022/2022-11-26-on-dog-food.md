---
title: On dog food, the (original) Metaverse, and (not) being bored
category: Coding
...
Guide](/tag/norton-guide/) reader ([not my
first](https://github.com/davep/eg), not by [a long
...
![The initial screen of gridinfo, showing the main SL stats](/attachments/2022/11/26/gridinfo-1.webp#centre)
...
![The main Unbored screen](/attachments/2022/11/26/unbored-1.webp#centre)

and here's a view of the filter pop-over:

![Setting filters for activities](/attachments/2022/11/26/unbored-2.webp#centre)
...
> devlog](https://textual.textualize.io/blog/2022/11/26/on-dog-food-the-original-metaverse-and-not-being-bored/).

[^1]: Far future edit: it didn't happen, [but I did eventually build it](/2025/03/12/aging.html).

[//]: # (2022-11-26-on-dog-food.md ends here)
