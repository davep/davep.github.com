...
cover: /attachments/2017/03/10/ngserve.webp
---
...
![ngserve in action](/attachments/2017/03/10/ngserve.webp#centre)

When run, you give it a list of guides to serve:

![Starting ngserve](/attachments/2017/03/10/starting-ngserve.webp#centre)

and it does the right thing. It has a small number of command line options
that help configure what it does:

![ngserve command line options](/attachments/2017/03/10/ngserve-cli.webp#centre)
