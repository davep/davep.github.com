...
title: PISpy v0.6.0
category: Coding
tags: Coding, PyPI, Python, YouTube, terminal, textual
date: 2024-04-17 11:30:00 +0100
cover: /attachments/2024/04/17/pispy-cover.webp
---

Back in the very early days of the [Textual
adventure](/2024/03/28/goodbye-textualize.html), within the first month or
so of working on the framework, we [had a period of
dogfooding](/2022/11/26/on-dog-food.html). One of the projects I wrote
during that time was a little tool [I called
PISpy](/2022/12/08/be-the-keymaster.html#pispy).
...
PISpy can be installed with `pip` or (ideally) `pipx` [from
