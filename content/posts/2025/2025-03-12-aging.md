...
title: AgiNG
category: Coding
tags: AgiNG, Coding, Norton Guide, PyPI, Python, terminal, textual
date: 2025-03-12 08:00:00 +0000
cover: /attachments/2025/03/12/aging-social-banner.webp
---

![AgiNG](/attachments/2025/03/12/aging-social-banner.webp#centre)
...
Emacs](https://github.com/davep/eg.el), and also on the web (in multiple
...
developed [`ngdb.py`](https://ngdb.davep.dev). This is a library
...
![AgiNG in action](/attachments/2025/03/12/aging-textual-dark.webp#centre)
...
![AgiNG showing a long entry](/attachments/2025/03/12/aging-long-entry.webp#centre)
...
![AgiNG help](/attachments/2025/03/12/aging-help-screen.webp#centre)

or by pulling up the command palette:

![AgiNG command palette](/attachments/2025/03/12/aging-command-palette.webp#centre)
...
![Entry in textual-dark](/attachments/2025/03/12/textual-dark.webp#centre)

Notice the colouring in the syntax section. This is more obvious if the
application is switched to one of the light themes:

![Entry in Solarized-Light](/attachments/2025/03/12/solarized-light.webp#centre)
...
![Classic view in action](/attachments/2025/03/12/classic-view.webp#centre)
...
![Nord](/attachments/2025/03/12/aging-nord.webp#centre)
![Textual Light](/attachments/2025/03/12/aging-textual-light.webp#centre)
![Gruvbox](/attachments/2025/03/12/aging-gruvbox.webp#centre)
![Solarize Light](/attachments/2025/03/12/aging-solarized-light.webp#centre)
![Monokai](/attachments/2025/03/12/aging-monokai.webp#centre)
