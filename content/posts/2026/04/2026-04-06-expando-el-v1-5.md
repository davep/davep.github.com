...
cover: /attachments/2026/04/06/expando.png
---
...
![expando in action](/attachments/2026/04/06/expando.png#centre)

This release simply adds a `lexical-binding` header to the file, and also
adds a `q` key binding to the resulting view window so that it can be
quickly and easily closed.
