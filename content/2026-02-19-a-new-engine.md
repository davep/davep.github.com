...
now](/2023/07/05/the-switch-has-been-made.html) this blog has been built
with [Pelican](https://getpelican.com). For the most part I've enjoyed using
it, it's been easy enough to work with, although not exciting to work with
(which I think is a positive thing to say about a static site generator).

There were, however, a couple or so things I didn't like about the layout I
...
them broken down by date or something, at least.

Of course, there are lots of themes, and it also uses templates, so I could
...
Thankfully, every time that happened, I'd come to my senses and go off and
work on some other fun personal project. Until earlier this week, that was.

The thing is... I've been looking for a project where I could dive into the
...
of people who champion these tools.

The only way I'm going to have an informed opinion is to get informed; the
only way to get informed is to try this stuff out.

So, here I am, with my blog now migrated over to
[BlogMore](https://blogmore.davep.dev); a project that gives me a
blog-focused static site generator that I 100% drove the development of, but
for which I wrote almost none of the code.

At the moment it's working out well, as a generator. I'm happy with how it
...
see anything odd happening, if you do see anything that looks broken, [I'd
love to hear about
...
[//]: # (2026-02-19-a-new-engine.md ends here)
