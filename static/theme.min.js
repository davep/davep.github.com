...
function setupBurgerMenu(){const burgerButton=document.querySelector('.burger-menu');const sidebar=document.querySelector('.sidebar');if(burgerButton&&sidebar){function toggleBurgerMenu(){const expanded=sidebar.classList.toggle('sidebar-expanded');burgerButton.setAttribute('aria-expanded',expanded?'true':'false');}
burgerButton.addEventListener('click',toggleBurgerMenu);}}
function setupUIFeatures(){setupThemeToggle();setupBurgerMenu();}
initTheme();if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',setupUIFeatures);}else{setupUIFeatures();}
